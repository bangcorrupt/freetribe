...
#ifdef USE_FONT_4X6
const UG_FONT FONT_4X6 = {
    (unsigned char *)font_4x6, FONT_TYPE_1BPP, 4, 6, 0, 255, NULL};
#endif
#ifdef USE_FONT_5X8
const UG_FONT FONT_5X8 = {
    (unsigned char *)font_5x8, FONT_TYPE_1BPP, 5, 8, 0, 255, NULL};
#endif
#ifdef USE_FONT_5X12
const UG_FONT FONT_5X12 = {
    (unsigned char *)font_5x12, FONT_TYPE_1BPP, 5, 12, 0, 255, NULL};
#endif
#ifdef USE_FONT_6X8
const UG_FONT FONT_6X8 = {
    (unsigned char *)font_6x8, FONT_TYPE_1BPP, 6, 8, 0, 255, NULL};
#endif
#ifdef USE_FONT_6X10
const UG_FONT FONT_6X10 = {
    (unsigned char *)font_6x10, FONT_TYPE_1BPP, 6, 10, 0, 255, NULL};
#endif
#ifdef USE_FONT_7X12
const UG_FONT FONT_7X12 = {
    (unsigned char *)font_7x12, FONT_TYPE_1BPP, 7, 12, 0, 255, NULL};
#endif
#ifdef USE_FONT_8X8
const UG_FONT FONT_8X8 = {
    (unsigned char *)font_8x8, FONT_TYPE_1BPP, 8, 8, 0, 255, NULL};
#endif
#ifdef USE_FONT_8X12
const UG_FONT FONT_8X12 = {
    (unsigned char *)font_8x12, FONT_TYPE_1BPP, 8, 12, 0, 255, NULL};
#endif
...
#endif
#ifdef USE_FONT_8X14
const UG_FONT FONT_8X14 = {
    (unsigned char *)font_8x14, FONT_TYPE_1BPP, 8, 14, 0, 255, NULL};
#endif
#ifdef USE_FONT_10X16
const UG_FONT FONT_10X16 = {
    (unsigned char *)font_10x16, FONT_TYPE_1BPP, 10, 16, 0, 255, NULL};
#endif
#ifdef USE_FONT_12X16
const UG_FONT FONT_12X16 = {
    (unsigned char *)font_12x16, FONT_TYPE_1BPP, 12, 16, 0, 255, NULL};
#endif
#ifdef USE_FONT_12X20
const UG_FONT FONT_12X20 = {
    (unsigned char *)font_12x20, FONT_TYPE_1BPP, 12, 20, 0, 255, NULL};
#endif
#ifdef USE_FONT_16X26
const UG_FONT FONT_16X26 = {
    (unsigned char *)font_16x26, FONT_TYPE_1BPP, 16, 26, 0, 255, NULL};
#endif
#ifdef USE_FONT_22X36
const UG_FONT FONT_22X36 = {
    (unsigned char *)font_22x36, FONT_TYPE_1BPP, 22, 36, 0, 255, NULL};
#endif
#ifdef USE_FONT_24X40
const UG_FONT FONT_24X40 = {
    (unsigned char *)font_24x40, FONT_TYPE_1BPP, 24, 40, 0, 255, NULL};
#endif
#ifdef USE_FONT_32X53
const UG_FONT FONT_32X53 = {
    (unsigned char *)font_32x53, FONT_TYPE_1BPP, 32, 53, 0, 255, NULL};
#endif
...
void UG_FontSelect(const UG_FONT *font) { gui->font = *font; }
...
void UG_FontSetHSpace(UG_U16 s) { gui->char_h_space = s; }

void UG_FontSetVSpace(UG_U16 s) { gui->char_v_space = s; }
...
void _UG_PutChar(char chr, UG_S16 x, UG_S16 y, UG_COLOR fc, UG_COLOR bc,
    ...
    if (gui->driver[DRIVER_FILL_AREA].state & DRIVER_ENABLED) {
        ...
        push_pixel = ((void *(*)(UG_S16, UG_S16, UG_S16, UG_S16))gui
                          ...
                          .driver)(x, y, x + actual_char_width - 1,
...
void _UG_PutText(UG_TEXT *txt) {
    ...
    while (1) {
        ...
        while ((*c != 0) && (*c != '\n')) {
            ...
            sl++;
            wl += (txt->font->widths
                       ? txt->font->widths[*c - txt->font->start_char]
                       : char_width) +
                  char_h_space;
            c++;
        }
...
/* --------------------------------------------------------------------------------
 */
UG_RESULT UG_CheckboxCreate(UG_WINDOW *wnd, UG_CHECKBOX *chb, UG_U8 id,
        ...
        if (obj->state & OBJ_STATE_VISIBLE) {
            ...
            if (chb->checked) {
                ...
                UG_DrawLine(obj->a_abs.xs + d2 + d - 1, obj->a_abs.ys + d + 1,
                            obj->a_abs.xs + d + 1, obj->a_abs.ys + d2 + d - 1,
                            chb->fc);
                UG_DrawLine(obj->a_abs.xs + d2 + d - 1, obj->a_abs.ys + d,
                            obj->a_abs.xs + d, obj->a_abs.ys + d2 + d - 1,
                            chb->fc);
                UG_DrawLine(obj->a_abs.xs + d2 + d - 2, obj->a_abs.ys + d,
                            obj->a_abs.xs + d, obj->a_abs.ys + d2 + d - 2,
                            chb->fc);
            } else {
                UG_DrawLine(obj->a_abs.xs + d + 1, obj->a_abs.ys + d,
                            obj->a_abs.xs + d2 + d - 1,
        ...
        if (obj->state & OBJ_STATE_VISIBLE) {
            ...
            if (obj->state & OBJ_STATE_REDRAW) {
                ...
                if ((img->img != NULL) && (img->type & IMG_TYPE_BMP)) {
                    UG_DrawBMP(obj->a_abs.xs, obj->a_abs.ys,
                               (UG_BMP *)img->img);
                }
