...
static const fix16_t fix16_max =
    0x7FFFFFFF; /*!< the maximum value of fix16_t */
static const fix16_t fix16_min =
...
/* static inline fix16_t fix16_add(fix16_t inArg0, fix16_t inArg1) { return
 * (inArg0 + inArg1); } */
/* static inline fix16_t fix16_sub(fix16_t inArg0, fix16_t inArg1) { return
 * (inArg0 - inArg1); } */
