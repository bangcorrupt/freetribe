...
const svf_func_t svf_funcs[3][4] = {
    {filter_svf_hpf_next, filter_svf_bpf_next, filter_svf_lpf_next,
     filter_svf_notch_next},
    {filter_svf_softclip_hpf_next, filter_svf_softclip_bpf_next,
     filter_svf_softclip_lpf_next, filter_svf_softclip_notch_next},
    {filter_svf_softclip_asym_hpf_next, filter_svf_softclip_asym_bpf_next,
     filter_svf_softclip_asym_lpf_next, filter_svf_softclip_asym_notch_next}};
