...
// get the next value
fract32 env_exp_next(env_exp *env) { return (*(env->stateFP))(env); }
...
void env_exp_set_sus_dur(env_exp *env, u32 samps) { env->susDur = samps; }
...
static fract32 next_sus_trig0(env_exp *env) { return env->valSus; }
...
// off
static fract32 next_off(env_exp *env) { return 0; }
