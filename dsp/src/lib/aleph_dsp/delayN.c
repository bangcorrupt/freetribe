...
// set erase level
extern void delayN_set_pre(delayN *dl, fract32 pre) { dl->preLevel = pre; }

// set write level
extern void delayN_set_write(delayN *dl, u8 write) { dl->write = write; }
...
// set read run flag
extern void delayN_set_run_read(delayN *dl, u8 val) { dl->runRd = val; }

// set write run flag
extern void delayN_set_run_write(delayN *dl, u8 val) { dl->runWr = val; }

/// TODO: What is 'id' parameter?
///         Causes error that tapRd is not subscriptable.
///         Should this be dl[id]->tapRd ?
//
